...
<xsl:stylesheet
        ...
        <div class="item-summary-view-metadata">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    ...
                    <xsl:call-template name="itemSummaryView-DIM-IDENTIFIER-DOI"/>
    ...
    <xsl:template name="itemSummaryView-DIM-IDENTIFIER-DOI">
        ...
        <tr>
            ...
            <td class="word-break">
                <xsl:choose>
                    ...
                    <xsl:when test="@mdschema='dc' and @element='relation' and @qualifier='uri' and contains(.,'http')">
                        <a>
                            <xsl:attribute name="href">
                                <xsl:copy-of select='node()'/>
                            </xsl:attribute>
