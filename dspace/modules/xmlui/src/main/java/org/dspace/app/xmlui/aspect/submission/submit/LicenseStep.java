...
/**
 * This is the last step of the item submission processes. During this step the
 * user must agree to the collection's standard distribution license. If the
 * user can not agree to the license they they may either save the submission
 * until a later time or remove the submission completely.
 *
 * This step will include the full license text inside the page using the HTML
 * fragment method.
 *
 *
...
public class LicenseStep extends AbstractSubmissionStep {
    ...
    protected static final Message T_info_ou1
            = message("xmlui.Submission.submit.LicenseStep.infoou1");
    protected static final Message T_info_ou2
            = message("xmlui.Submission.submit.LicenseStep.infoou2");
    protected static final Message T_info_ou3
            = message("xmlui.Submission.submit.LicenseStep.infoou3");
    ...
    public void addBody(Body body) throws SAXException, WingException,
        ...
        if (handle.equals("11244/10476") || handle.equals("11244/23528")) {
            inner.addPara(T_info_ou1);
            inner.addPara(T_info_ou2);
        } else {
     ...
     * the reviewable information. If this step has nothing to review, then
     * return null!
     */
