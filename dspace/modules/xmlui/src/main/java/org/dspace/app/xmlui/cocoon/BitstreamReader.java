...
public class BitstreamReader extends AbstractReader implements Recyclable
{
    ...
    private  String AUTH_REQUIRED_EMBARGO_MESSAGE = "xmlui.BitstreamReader.auth_embargo_message";
    private  String AUTH_REQUIRED_RESTRICTED_MESSAGE = "xmlui.BitstreamReader.auth_restricted_message";
