...
public class UploadWithEmbargoStep extends UploadStep
{
    ...
    protected static final Message T_file_help =
		...
		protected static final Message T_file_help1 =
        message("xmlui.Submission.submit.UploadWithEmbargoStep.file_help1");
            ...
            UIException, SQLException, IOException, AuthorizeException
    {
    	...
    	if (!disableFileEditing)
    	{
          ...
          // applies to desertation and thesis
          if (collection.getHandle().equals("11244/10476") || collection.getHandle().equals("11244/23528")) {
              file.setHelp(T_file_help1);
          }
          else{
          ...
          // applies to desertation and thesis
          if (collection.getHandle().equals("11244/10476") || collection.getHandle().equals("11244/23528")) {
              description.setHelp(T_description_help1);
          }
          else{
