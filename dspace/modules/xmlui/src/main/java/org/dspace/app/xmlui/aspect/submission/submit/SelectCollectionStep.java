...
public class SelectCollectionStep extends AbstractSubmissionStep
{
            ...
            UIException, SQLException, IOException, AuthorizeException
    {
        ...
        // TreeMap<String, String> collectionNames = new TreeMap<String, String>();
        // for (Collection collection : collections)
        // {
        //     String name = collection.getMetadata("name");
        //     String commName = collection.getCommunities()[0].getName();
        //     collectionNames.put(commName+"::"+name,collection.getHandle());
        // }
        ...
        //     select.addOption(entry.getValue(),entry.getKey());
        // }
