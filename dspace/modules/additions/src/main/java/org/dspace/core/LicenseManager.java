...
public class LicenseManager
{
    ...
    /**
     * Get the OU thesis and dissertation distribution license that submitters need to grant
     *
     * @return the distribution license
     */
    public static String getOUDistributionSubmissionLicense()
    {
        initOUDistribution();
        return license;
    }
     ...
     * Load in the default license.
     */
    private static void initOUDistribution()
    {
        
        File licenseFile = new File(ConfigurationManager.getProperty("dspace.dir")
                + File.separator + "config" + File.separator + "ou-distribution.license");
